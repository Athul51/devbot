...
if choice.lower() == 'n':
	...
	accessToken =  "ZmE1ZTQ0ODctOTRhZS00NzIwLThmM2UtMTJkNGRiNDdlN2UxYTIwZTg2MGMtNzE5_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"

# 3. Provide the URL to the Webex Teams room API.
webex_rooms_url = "https://webexapis.com/v1/rooms"
r = requests.get(   webex_rooms_url,
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "S8rGaaHTvX4MacAx90Cy57MVjMF6CPx4"
                               }
...
# 9. Provide the URL to the Sunrise/Sunset API.
        r = requests.get("https://api.sunrise-sunset.org/json?lat=47.36581&lng=-82.10139&formatted=0", 
